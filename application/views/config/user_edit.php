		    ...
		    <div class="box-body">	
		    	  ...
		    	  <div class="row">
						...
						<div class="form-group col-md-6">
					        <label>Naam</label>
					        <input type="text" class="form-control" placeholder="Naam" value="<?=$user_data['0']->name?>" name="name">
					    </div>
					    ...
					    <div class="form-group col-md-6">
					        ...
					        <input type="text" class="form-control" placeholder="Gebruikersnaam" value="<?=$user_data['0']->username?>" name="username">
					    </div>
		    		</div>
